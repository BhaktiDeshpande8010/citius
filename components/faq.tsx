    ...
    <section id="faq" className="py-24 lg:py-32 bg-white">
      <div className="max-w-3xl mx-auto px-6 lg:px-8">
        ...
        <div className="space-y-4">
          {faqs.map((faq, index) => (
            ...
            >
              ...
              >
                <span className="font-semibold text-slate-900 pr-8 group-hover:text-emerald-600 transition-colors">
                  {faq.question}
                </span>
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="mt-12 text-center p-8 bg-slate-50 rounded-3xl"
        >
